...
function Login() {
  ...
  return (
    <>
      ...
      <Form onFinish={onFinish} className="min-h-screen flex flex-col lg:flex-row">
        {/* Background Image - Hidden on mobile, visible on large screens */}
        <div
          className="hidden lg:flex w-full lg:w-3/4 relative"
          style={{
        ...
        >
          <div className="flex items-center h-full w-full px-8 xl:px-20 bg-gray-900 bg-opacity-40"></div>
        </div>
        
        {/* Login Form */}
        <div className="from-gray-50 to-blue-500 bg-gradient-to-r flex w-full lg:w-1/2 justify-center items-center space-y-6 lg:space-y-8 py-8 lg:py-0">
          <div className="w-full max-w-md px-4 sm:px-6 md:px-8 lg:px-12 xl:px-24">
            <div className="flex flex-col items-center mb-6 lg:mb-10">
              <Link
                to="/"
                className="relative inline-flex items-center justify-center p-3 px-4 lg:p-4 lg:px-6 py-2 lg:py-3 overflow-hidden font-medium text-blue-600 transition duration-300 ease-out border-2 border-blue-600 rounded-full shadow-md group text-sm lg:text-base"
              >
            ...
            <h1 className="mb-6 lg:mb-8 text-3xl sm:text-4xl lg:text-5xl text-center font-bold italic">
              Login
            </h1>
            <Form.Item
              name="email"
            ...
            <div className="flex justify-center mb-4 lg:mb-5">
              <button
                ...
                px-8 lg:px-10 py-2 lg:py-3 overflow-hidden font-bold rounded-full
