...
function Contact() {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us - A & N Travel and Tours</title>
      </Helmet>
        ...
        <section className="bg-gradient-to-r from-orange-500 to-orange-600 text-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-orange-100 max-w-3xl mx-auto">
              Get in touch with us for any questions about our Sundarbans boat tours or travel packages
            </p>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-8">
                  We're here to help you plan your perfect Sundarbans adventure. 
                  Reach out to us with any questions or special requests.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">01511296000 / 01511196910</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">anttbd24@gmail.com</p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="booking">Boat Booking Inquiry</option>
                ...
                <button
                  type="submit"
                  className="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold py-4 px-8 rounded-lg text-lg transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl"
                >
                  Send Message
                </button>
              </form>
